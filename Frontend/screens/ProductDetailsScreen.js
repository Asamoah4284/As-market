...
const ProductDetailsScreen = () => {
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(`http://172.20.10.3:5000/api/products/${productId}/comments`);
        ...
        <View style={styles.productInfoContainer}>
          ...
          <View style={styles.specificationsContainer}>
            ...
            <View style={styles.specItem}>
              ...
              <Text style={styles.specValue}>{product.category || 'Electronics'}</Text>
            </View>
            <View style={styles.specItem}>
              <Text style={styles.specLabel}>In Stock</Text>
              <Text style={styles.specValue}>{product.countInStock > 0 ? 'Yes' : 'No'}</Text>
            </View>
          </View>
